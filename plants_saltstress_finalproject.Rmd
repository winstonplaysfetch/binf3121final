...
fit2 = eBayes(fit2)
```
When using GCRMA, we got the following error:
"Zero sample variances detected, have been offset away from zero"
The below link explains that for values with zero sample variances, the values for the test statistic have been slightly moved from zero.

https://stat.ethz.ch/pipermail/bioconductor/2007-May/017025.html
